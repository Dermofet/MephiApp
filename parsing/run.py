...
if __name__ == '__main__':
    ...
    try:
        ...
        loop.run_until_complete(bulk_insert_room(get_session()))
        print("Completed: Rooms")
        print()

        print("--SET INFO--: Academic")
        loop.run_until_complete(bulk_insert_academic(get_session()))
        print("Completed: Academic")
        print()

        print("--SET INFO--: Groups")
        loop.run_until_complete(bulk_insert_groups(get_session()))
        print("Completed: Groups")
        print()

        print("--PARSE INFO--: Teachers")
        loop.run_until_complete(bulk_insert_teachers_fullname(get_session()))
        print("Completed: Teachers")
        print()

        print("--SET INFO--: Schedule")
        loop.run_until_complete(bulk_insert_schedule(get_session()))
